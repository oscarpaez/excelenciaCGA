...
@Entity
public class HistoricaCargaTrabajo implements Serializable{
	
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	private int id;
	
	private int idCargaTrabajo;
	...
	public int getIdCargaTrabajo() {
		return idCargaTrabajo;
	}

	public void setIdCargaTrabajo(int idCargaTrabajo) {
		this.idCargaTrabajo = idCargaTrabajo;
	}	
}
