...
@Entity
public class PresupuestoE implements Serializable{
	...
	public BigDecimal getDistribucionPorUtilidad() {
		return distribucionPorUtilidad;
	}

	public void setDistribucionPorUtilidad(BigDecimal distribucionPorUtilidad) {
		this.distribucionPorUtilidad = distribucionPorUtilidad;
	}
